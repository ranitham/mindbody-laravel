...
**StartDate** | [**\DateTime**](\DateTime.md) | Filters results to pricing options that are valid on or after this date. | [optional] 
**EndDate** | [**\DateTime**](\DateTime.md) | Filters results to pricing options that are valid on or before this date. | [optional] 
