...
**SiteId** | **int** | The ID of the site the visit occurred | [optional] 
...
**VisitType** | **int** | Indicates the class visit type id | [optional] 
**TypeGroup** | **int** | Indicates the type group id of the class | [optional] 
**TypeTaken** | **string** | Indicates the type taken by the class | [optional] 
