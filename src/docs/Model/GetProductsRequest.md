...
**CategoryIds** | **int[]** | A list of revenue category IDs to filter by. Use this ID when calling the GET Categories endpoint. | [optional] 
**SubCategoryIds** | **int[]** | A list of subcategory IDs to filter by. Use this ID when calling the GET Categories endpoint. | [optional] 
**SecondaryCategoryIds** | **int[]** | A list of secondary categories to filter by. Use this ID when calling the GET Categories endpoint. | [optional] 
