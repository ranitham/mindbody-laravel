...
------------ | ------------- | ------------- | -------------
**ClientIDs** | **string[]** | The requested client IDs.  Default: **all IDs** that the authenticated user’s access level allows. | [optional] 
...
**IncludeInactive** | **bool** | When &#x60;true&#x60;, indicates the results to include active and inactive clients.&lt;br /&gt;  When &#x60;false&#x60;, indicates that only those clients who are marked as active should be returned. | [optional] 
