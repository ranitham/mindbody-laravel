...
**CrossRegionalLookup** | **bool** | Used to retrieve a client’s data from multiple sites within an organization.  Default: **false** | [optional] 
...
**RequiredClientData** | **string[]** | Used to store the required type of data for particular client | [optional] 
