...
**ClientId** | **string** | The ID of the client. Note that this is not the same as the client’s unique ID. | [optional] 
**UniqueClientId** | **int** | The unique ID of the client.  Note: you need to provide the &#39;UniqueClientId&#39; OR the &#39;ClientId&#39;. If both are provided, the &#39;UniqueClientId&#39; takes precedence. | [optional] 
...
**CreditCardInfo** | [**\Nlocascio\Mindbody\Model\CreditCardInfo**](CreditCardInfo.md) | Contains credit card payment information.&lt;br /&gt;  This is only required if &#x60;StoredCardInfo&#x60; is not passed and both &#x60;UseDirectDebit&#x60; and &#x60;UseAccountCredit&#x60; are &#x60;false&#x60;. | [optional] 
**StoredCardInfo** | [**\Nlocascio\Mindbody\Model\StoredCardInfo**](StoredCardInfo.md) | Contains information about the stored credit card payment.&lt;br /&gt;  This is only required if &#x60;CreditCardInfo&#x60; is not passed and both &#x60;UseDirectDebit&#x60; and &#x60;UseAccountCredit&#x60; and are &#x60;false&#x60;. | [optional] 
...
**UseDirectDebit** | **bool** | When &#x60;true&#x60;, indicates that the direct debit information stored on the client&#39;s account is to be used to pay for the contract.&lt;br /&gt;  This is only required if both &#x60;CreditCardInfo&#x60; and &#x60;StoredCardInfo&#x60; are not passed and &#x60;UseAccountCredit&#x60; is false.&lt;br /&gt;  Default: **false** | [optional] 
**UseAccountCredit** | **bool** | When &#x60;true&#x60;, indicates that the account credit of the client&#39;s account is to be used to pay for the contract.&lt;br /&gt;  This is only required if both &#x60;CreditCardInfo&#x60; and &#x60;StoredCardInfo&#x60; are not passed and &#x60;UseDirectDebit&#x60; is false. &lt;br /&gt;  Default: **false** | [optional] 
