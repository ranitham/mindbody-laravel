...
------------ | ------------- | ------------- | -------------
**ScheduledServiceType** | **string** | Filters the results to schedule service earnings for specific types of services. Possible values:  * Class  * Appointment | [optional] 
**ScheduledServiceId** | **int** | Filters the results to a single scheduled service. This parameter must be used with a single ScheduledServiceType. | [optional] 
