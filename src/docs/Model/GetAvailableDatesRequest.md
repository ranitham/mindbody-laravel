...
------------ | ------------- | ------------- | -------------
**SessionTypeId** | **int** | required requested session type ID. | 
**LocationId** | **int** | optional requested location ID. | [optional] 
**StaffId** | **int** | optional requested staff ID. | [optional] 
