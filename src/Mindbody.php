 ...
 * @method static \Nlocascio\Mindbody\Model\GetClassVisitsResponse classGetClassVisits(int $RequestClassID, \DateTime $RequestLastModifiedDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetClassVisitsResponse GetClassVisits(int $RequestClassID, \DateTime $RequestLastModifiedDate = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetClientScheduleResponse clientGetClientSchedule(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientScheduleResponse GetClientSchedule(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientServicesResponse clientGetClientServices(string $RequestClientId, int $RequestClassId = null, int $RequestClientAssociatedSitesOffset = null, string[] $RequestClientIds = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestIgnoreCrossRegionalSiteLimit = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int $RequestSessionTypeId = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, bool $RequestUseActivateDate = null, int $RequestVisitCount = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientServicesResponse GetClientServices(string $RequestClientId, int $RequestClassId = null, int $RequestClientAssociatedSitesOffset = null, string[] $RequestClientIds = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestIgnoreCrossRegionalSiteLimit = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int $RequestSessionTypeId = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, bool $RequestUseActivateDate = null, int $RequestVisitCount = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetCrossRegionalClientAssociationsResponse clientGetCrossRegionalClientAssociations(string $RequestClientId = null, string $RequestEmail = null, string $RequestFirstName = null, string $RequestLastName = null, int $RequestLimit = null, int $RequestOffset = null, bool $RequestV2 = null);
 * @method static \Nlocascio\Mindbody\Model\GetCrossRegionalClientAssociationsResponse GetCrossRegionalClientAssociations(string $RequestClientId = null, string $RequestEmail = null, string $RequestFirstName = null, string $RequestLastName = null, int $RequestLimit = null, int $RequestOffset = null, bool $RequestV2 = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetContractsResponse saleGetContracts(int $RequestLocationId, int $RequestConsumerId = null, int[] $RequestContractIds = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestPromoCode = null, bool $RequestSoldOnline = null);
 * @method static \Nlocascio\Mindbody\Model\GetContractsResponse GetContracts(int $RequestLocationId, int $RequestConsumerId = null, int[] $RequestContractIds = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestPromoCode = null, bool $RequestSoldOnline = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\InitializeCreditCardEntryResponse saleInitializeCreditCardEntry(\Nlocascio\Mindbody\Model\InitializeCreditCardEntryRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\InitializeCreditCardEntryResponse InitializeCreditCardEntry(\Nlocascio\Mindbody\Model\InitializeCreditCardEntryRequest $Request);
 ...
 * @method static object siteGetResources(\DateTime $RequestEndDateTime = null, bool $RequestIncludeInactive = null, int $RequestLimit = null, int $RequestLocationId = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, int[] $RequestSessionTypeIds = null, \DateTime $RequestStartDateTime = null);
 * @method static object GetResources(\DateTime $RequestEndDateTime = null, bool $RequestIncludeInactive = null, int $RequestLimit = null, int $RequestLocationId = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, int[] $RequestSessionTypeIds = null, \DateTime $RequestStartDateTime = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetSitesResponse siteGetSites(bool $RequestIncludeLeadChannels = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSiteIds = null);
 * @method static \Nlocascio\Mindbody\Model\GetSitesResponse GetSites(bool $RequestIncludeLeadChannels = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSiteIds = null);
 * @method static \Nlocascio\Mindbody\Model\GetResourcesResponse siteSiteGetResourceAvailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetResourcesResponse SiteGetResourceAvailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, \DateTime $RequestStartDate = null);
