 ...
 * @method static \Nlocascio\Mindbody\Model\AddAvailabilitiesResponse appointmentAddAvailabilities(\Nlocascio\Mindbody\Model\AddAvailabilitiesRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\AddAvailabilitiesResponse AddAvailabilities(\Nlocascio\Mindbody\Model\AddAvailabilitiesRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\AddMultipleAppointmentsResponse appointmentAddMultipleAppointments(\Nlocascio\Mindbody\Model\AddMultipleAppointmentsRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\AddMultipleAppointmentsResponse AddMultipleAppointments(\Nlocascio\Mindbody\Model\AddMultipleAppointmentsRequest $Request);
 * @method static void appointmentDeleteAppointmentAddOn(int $Id);
 * @method static void DeleteAppointmentAddOn(int $Id);
 * @method static void appointmentDeleteAvailability(int $DeleteAvailabilityRequestAvailabilityId = null, bool $DeleteAvailabilityRequestTest = null);
 * @method static void DeleteAvailability(int $DeleteAvailabilityRequestAvailabilityId = null, bool $DeleteAvailabilityRequestTest = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetBookableItemsResponse appointmentGetBookableItems(int[] $RequestSessionTypeIds, int $RequestAppointmentId = null, \DateTime $RequestEndDate = null, bool $RequestIgnoreDefaultSessionLength = null, bool $RequestIncludeResourceAvailability = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetBookableItemsResponse GetBookableItems(int[] $RequestSessionTypeIds, int $RequestAppointmentId = null, \DateTime $RequestEndDate = null, bool $RequestIgnoreDefaultSessionLength = null, bool $RequestIncludeResourceAvailability = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDate = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetUnavailabilitiesResponse appointmentGetUnavailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetUnavailabilitiesResponse GetUnavailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDate = null);
 * @method static void appointmentRemoveFromWaitlist(int[] $RequestWaitlistEntryIds);
 ...
 * @method static \Nlocascio\Mindbody\Model\UpdateAvailabilityResponse appointmentUpdateAvailability(\Nlocascio\Mindbody\Model\UpdateAvailabilityRequest $UpdateAvailabilityRequest);
 * @method static \Nlocascio\Mindbody\Model\UpdateAvailabilityResponse UpdateAvailability(\Nlocascio\Mindbody\Model\UpdateAvailabilityRequest $UpdateAvailabilityRequest);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo classAddClassSchedule(\Nlocascio\Mindbody\Model\AddClassEnrollmentScheduleRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo AddClassSchedule(\Nlocascio\Mindbody\Model\AddClassEnrollmentScheduleRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\CancelSingleClassResponse classCancelSingleClass(\Nlocascio\Mindbody\Model\CancelSingleClassRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\CancelSingleClassResponse CancelSingleClass(\Nlocascio\Mindbody\Model\CancelSingleClassRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\GetClassDescriptionsResponse classGetClassDescriptions(int $RequestClassDescriptionId = null, \DateTime $RequestEndClassDateTime = null, bool $RequestIncludeInactive = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int $RequestStaffId = null, \DateTime $RequestStartClassDateTime = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetClassVisitsResponse classGetClassVisits(int $RequestClassID, \DateTime $RequestLastModifiedDate = null, bool $RequestUseSiteSettingsStaffName = null);
 * @method static \Nlocascio\Mindbody\Model\GetClassVisitsResponse GetClassVisits(int $RequestClassID, \DateTime $RequestLastModifiedDate = null, bool $RequestUseSiteSettingsStaffName = null);
 * @method static \Nlocascio\Mindbody\Model\GetClassesResponse classGetClasses(int[] $RequestClassDescriptionIds = null, int[] $RequestClassIds = null, int[] $RequestClassScheduleIds = null, string $RequestClientId = null, \DateTime $RequestEndDateTime = null, bool $RequestHideCanceledClasses = null, \DateTime $RequestLastModifiedDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, bool $RequestSchedulingWindow = null, int[] $RequestSemesterIds = null, int[] $RequestSessionTypeIds = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDateTime = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetClassesResponse GetClasses(int[] $RequestClassDescriptionIds = null, int[] $RequestClassIds = null, int[] $RequestClassScheduleIds = null, string $RequestClientId = null, \DateTime $RequestEndDateTime = null, bool $RequestHideCanceledClasses = null, \DateTime $RequestLastModifiedDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, bool $RequestSchedulingWindow = null, int[] $RequestSemesterIds = null, int[] $RequestSessionTypeIds = null, int[] $RequestStaffIds = null, \DateTime $RequestStartDateTime = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetCoursesReponse classGetCourses(int[] $GetCoursesRequestCourseIDs = null, \DateTime $GetCoursesRequestEndDate = null, int $GetCoursesRequestLimit = null, int[] $GetCoursesRequestLocationIDs = null, int $GetCoursesRequestOffset = null, int[] $GetCoursesRequestProgramIDs = null, int[] $GetCoursesRequestSemesterIDs = null, int[] $GetCoursesRequestStaffIDs = null, \DateTime $GetCoursesRequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetCoursesReponse GetCourses(int[] $GetCoursesRequestCourseIDs = null, \DateTime $GetCoursesRequestEndDate = null, int $GetCoursesRequestLimit = null, int[] $GetCoursesRequestLocationIDs = null, int $GetCoursesRequestOffset = null, int[] $GetCoursesRequestProgramIDs = null, int[] $GetCoursesRequestSemesterIDs = null, int[] $GetCoursesRequestStaffIDs = null, \DateTime $GetCoursesRequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetSemestersResponse classGetSemesters(bool $RequestActive = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSemesterIDs = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetSemestersResponse GetSemesters(bool $RequestActive = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSemesterIDs = null, \DateTime $RequestStartDate = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\RemoveClientsFromClassesResponse classRemoveClientsFromClasses(\Nlocascio\Mindbody\Model\RemoveClientsFromClassesRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\RemoveClientsFromClassesResponse RemoveClientsFromClasses(\Nlocascio\Mindbody\Model\RemoveClientsFromClassesRequest $Request);
 ...
 * @method static void classUpdateClass(\Nlocascio\Mindbody\Model\UpdateClassRequest $Request);
 * @method static void UpdateClass(\Nlocascio\Mindbody\Model\UpdateClassRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo classUpdateClassSchedule(\Nlocascio\Mindbody\Model\UpdateClassEnrollmentScheduleRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo UpdateClassSchedule(\Nlocascio\Mindbody\Model\UpdateClassEnrollmentScheduleRequest $Request);
 * @method static void classUpdateClassScheduleNotes(int $ClassScheduleId, \Nlocascio\Mindbody\Model\UpdateClassScheduleNotesRequest $Request);
 * @method static void UpdateClassScheduleNotes(int $ClassScheduleId, \Nlocascio\Mindbody\Model\UpdateClassScheduleNotesRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetActiveClientMembershipsResponse clientGetActiveClientMemberships(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetActiveClientMembershipsResponse GetActiveClientMemberships(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int $RequestUniqueClientId = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetClientCompleteInfoResponse clientGetClientCompleteInfo(string $RequestClientId, string $ConsumerIdentityToken =  "", int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestExcludeInactiveSites = null, string[] $RequestRequiredClientData = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, bool $RequestUseActivateDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientCompleteInfoResponse GetClientCompleteInfo(string $RequestClientId, string $ConsumerIdentityToken =  "", int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestExcludeInactiveSites = null, string[] $RequestRequiredClientData = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, bool $RequestUseActivateDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientContractsResponse clientGetClientContracts(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientContractsResponse GetClientContracts(string $RequestClientId, int $RequestClientAssociatedSitesOffset = null, bool $RequestCrossRegionalLookup = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestUniqueClientId = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetClientPurchasesResponse clientGetClientPurchases(string $RequestClientId, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestSaleId = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientPurchasesResponse GetClientPurchases(string $RequestClientId, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestSaleId = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetClientScheduleResponse clientGetClientSchedule(int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestIncludeWaitlistEntries = null, int $RequestLimit = null, int $RequestOffset = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientScheduleResponse GetClientSchedule(int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestIncludeWaitlistEntries = null, int $RequestLimit = null, int $RequestOffset = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientServicesResponse clientGetClientServices(int $RequestClassId = null, int[] $RequestClassScheduleID = null, int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, string[] $RequestClientIds = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestExcludeInactiveSites = null, bool $RequestIgnoreCrossRegionalSiteLimit = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int $RequestSessionTypeId = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, int[] $RequestUniqueClientIds = null, bool $RequestUseActivateDate = null, int $RequestVisitCount = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientServicesResponse GetClientServices(int $RequestClassId = null, int[] $RequestClassScheduleID = null, int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, string[] $RequestClientIds = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, bool $RequestExcludeInactiveSites = null, bool $RequestIgnoreCrossRegionalSiteLimit = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int $RequestSessionTypeId = null, bool $RequestShowActiveOnly = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, int[] $RequestUniqueClientIds = null, bool $RequestUseActivateDate = null, int $RequestVisitCount = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientVisitsResponse clientGetClientVisits(int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestOrder = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, bool $RequestUnpaidsOnly = null);
 * @method static \Nlocascio\Mindbody\Model\GetClientVisitsResponse GetClientVisits(int $RequestClientAssociatedSitesOffset = null, string $RequestClientId = null, bool $RequestCrossRegionalLookup = null, \DateTime $RequestEndDate = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestOrder = null, \DateTime $RequestStartDate = null, int $RequestUniqueClientId = null, bool $RequestUnpaidsOnly = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetCrossRegionalClientAssociationsResponse clientGetCrossRegionalClientAssociations(string $RequestClientId = null, string $RequestEmail = null, bool $RequestExcludeInactiveSites = null, string $RequestFirstName = null, string $RequestLastName = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestUniqueClientId = null, bool $RequestV2 = null);
 * @method static \Nlocascio\Mindbody\Model\GetCrossRegionalClientAssociationsResponse GetCrossRegionalClientAssociations(string $RequestClientId = null, string $RequestEmail = null, bool $RequestExcludeInactiveSites = null, string $RequestFirstName = null, string $RequestLastName = null, int $RequestLimit = null, int $RequestOffset = null, int $RequestUniqueClientId = null, bool $RequestV2 = null);
 ...
 * @method static object clientMergeClient(\Nlocascio\Mindbody\Model\MergeClientsRequest $Request);
 * @method static object MergeClient(\Nlocascio\Mindbody\Model\MergeClientsRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\SuspendContractResponse clientSuspendContract(\Nlocascio\Mindbody\Model\SuspendContractRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\SuspendContractResponse SuspendContract(\Nlocascio\Mindbody\Model\SuspendContractRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\TerminateContractResponse clientTerminateContract(\Nlocascio\Mindbody\Model\TerminateContractRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\TerminateContractResponse TerminateContract(\Nlocascio\Mindbody\Model\TerminateContractRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\Contract clientUpdateClientContractAutopays(\Nlocascio\Mindbody\Model\UpdateClientContractAutopaysRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\Contract UpdateClientContractAutopays(\Nlocascio\Mindbody\Model\UpdateClientContractAutopaysRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo enrollmentAddEnrollmentSchedule(\Nlocascio\Mindbody\Model\AddClassEnrollmentScheduleRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo AddEnrollmentSchedule(\Nlocascio\Mindbody\Model\AddClassEnrollmentScheduleRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo enrollmentUpdateEnrollmentSchedule(\Nlocascio\Mindbody\Model\UpdateClassEnrollmentScheduleRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\MindbodyPublicApiDataModelsWrittenClassSchedulesInfo UpdateEnrollmentSchedule(\Nlocascio\Mindbody\Model\UpdateClassEnrollmentScheduleRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\CheckoutShoppingCartResponse saleCheckoutShoppingCart(\Nlocascio\Mindbody\Model\CheckoutShoppingCartRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\CheckoutShoppingCartResponse CheckoutShoppingCart(\Nlocascio\Mindbody\Model\CheckoutShoppingCartRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\CheckoutShoppingCartResponse saleCompleteCheckoutShoppingCartUsingAlternativePayments(\Nlocascio\Mindbody\Model\CompleteCheckoutShoppingCartUsingAlternativePaymentsRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\CheckoutShoppingCartResponse CompleteCheckoutShoppingCartUsingAlternativePayments(\Nlocascio\Mindbody\Model\CompleteCheckoutShoppingCartUsingAlternativePaymentsRequest $Request);
 * @method static string[] saleGetAcceptedCardTypes();
 * @method static string[] GetAcceptedCardTypes();
 * @method static \Nlocascio\Mindbody\Model\GetAlternativePaymentMethodsResponse saleGetAlternativePaymentMethods(string $RequestClientId = null, int $RequestLocationId = null);
 * @method static \Nlocascio\Mindbody\Model\GetAlternativePaymentMethodsResponse GetAlternativePaymentMethods(string $RequestClientId = null, int $RequestLocationId = null);
 * @method static \Nlocascio\Mindbody\Model\GetContractsResponse saleGetContracts(int $RequestLocationId, int[] $RequestContractIds = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestPromoCode = null, bool $RequestSoldOnline = null, int $RequestUniqueClientId = null);
 * @method static \Nlocascio\Mindbody\Model\GetContractsResponse GetContracts(int $RequestLocationId, int[] $RequestContractIds = null, int $RequestLimit = null, int $RequestOffset = null, string $RequestPromoCode = null, bool $RequestSoldOnline = null, int $RequestUniqueClientId = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetGiftCardResponse saleGetGiftCards(int[] $RequestIds = null, bool $RequestIncludeCustomLayouts = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, bool $RequestSoldOnline = null);
 * @method static \Nlocascio\Mindbody\Model\GetGiftCardResponse GetGiftCards(int[] $RequestIds = null, bool $RequestIncludeCustomLayouts = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, bool $RequestSoldOnline = null);
 * @method static \Nlocascio\Mindbody\Model\GetPackagesResponse saleGetPackages(int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int[] $RequestPackageIds = null, bool $RequestSellOnline = null);
 * @method static \Nlocascio\Mindbody\Model\GetPackagesResponse GetPackages(int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int[] $RequestPackageIds = null, bool $RequestSellOnline = null);
 * @method static \Nlocascio\Mindbody\Model\GetProductsResponse saleGetProducts(int[] $RequestCategoryIds = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, string[] $RequestProductIds = null, string $RequestSearchText = null, int[] $RequestSecondaryCategoryIds = null, bool $RequestSellOnline = null, int[] $RequestSubCategoryIds = null);
 * @method static \Nlocascio\Mindbody\Model\GetProductsResponse GetProducts(int[] $RequestCategoryIds = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, string[] $RequestProductIds = null, string $RequestSearchText = null, int[] $RequestSecondaryCategoryIds = null, bool $RequestSellOnline = null, int[] $RequestSubCategoryIds = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\PurchaseContractResponse saleGetPurchaseContractStatus(string $AccessToken);
 * @method static \Nlocascio\Mindbody\Model\PurchaseContractResponse GetPurchaseContractStatus(string $AccessToken);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetServicesResponse saleGetServices(int $RequestClassId = null, int $RequestClassScheduleId = null, bool $RequestHideRelatedPrograms = null, bool $RequestIncludeDiscontinued = null, bool $RequestIncludeSaleInContractOnly = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int[] $RequestProgramIds = null, bool $RequestSellOnline = null, string[] $RequestServiceIds = null, int[] $RequestSessionTypeIds = null, int $RequestStaffId = null);
 * @method static \Nlocascio\Mindbody\Model\GetServicesResponse GetServices(int $RequestClassId = null, int $RequestClassScheduleId = null, bool $RequestHideRelatedPrograms = null, bool $RequestIncludeDiscontinued = null, bool $RequestIncludeSaleInContractOnly = null, int $RequestLimit = null, int $RequestLocationId = null, int $RequestOffset = null, int[] $RequestProgramIds = null, bool $RequestSellOnline = null, string[] $RequestServiceIds = null, int[] $RequestSessionTypeIds = null, int $RequestStaffId = null);
 ...
 * @method static object saleInitiateCheckoutShoppingCartUsingAlternativePayments(\Nlocascio\Mindbody\Model\InitiateCheckoutShoppingCartUsingAlternativePaymentsRequest $Request);
 * @method static object InitiateCheckoutShoppingCartUsingAlternativePayments(\Nlocascio\Mindbody\Model\InitiateCheckoutShoppingCartUsingAlternativePaymentsRequest $Request);
 * @method static object saleInitiatePurchaseContractUsingAlternativePayments(\Nlocascio\Mindbody\Model\InitiatePurchaseContractRequest $Request);
 * @method static object InitiatePurchaseContractUsingAlternativePayments(\Nlocascio\Mindbody\Model\InitiatePurchaseContractRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\ReturnSaleResponse saleReturnSale(\Nlocascio\Mindbody\Model\ReturnSaleRequest $ReturnSaleRequest);
 * @method static \Nlocascio\Mindbody\Model\ReturnSaleResponse ReturnSale(\Nlocascio\Mindbody\Model\ReturnSaleRequest $ReturnSaleRequest);
 * @method static \Nlocascio\Mindbody\Model\UpdateProductPriceResponse saleUpdateProductPrice(\Nlocascio\Mindbody\Model\UpdateProductPriceRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\UpdateProductPriceResponse UpdateProductPrice(\Nlocascio\Mindbody\Model\UpdateProductPriceRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\GetProductsResponse saleUpdateProducts(\Nlocascio\Mindbody\Model\UpdateProductRequest[] $UpdateProductsRequests);
 * @method static \Nlocascio\Mindbody\Model\GetProductsResponse UpdateProducts(\Nlocascio\Mindbody\Model\UpdateProductRequest[] $UpdateProductsRequests);
 * @method static \Nlocascio\Mindbody\Model\UpdateSaleDateResponse saleUpdateSaleDate(\Nlocascio\Mindbody\Model\UpdateSaleDateRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\UpdateSaleDateResponse UpdateSaleDate(\Nlocascio\Mindbody\Model\UpdateSaleDateRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\UpdateServiceResponse saleUpdateServices(\Nlocascio\Mindbody\Model\UpdateServiceRequest[] $UpdateServicesRequest);
 * @method static \Nlocascio\Mindbody\Model\UpdateServiceResponse UpdateServices(\Nlocascio\Mindbody\Model\UpdateServiceRequest[] $UpdateServicesRequest);
 * @method static \Nlocascio\Mindbody\Model\AddSiteClientIndexResponse siteAddClientIndex(\Nlocascio\Mindbody\Model\AddSiteClientIndexRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\AddSiteClientIndexResponse AddClientIndex(\Nlocascio\Mindbody\Model\AddSiteClientIndexRequest $Request);
 ...
 * @method static object siteDeactivatePromoCode(\Nlocascio\Mindbody\Model\DeactivatePromoCodeRequest $Request);
 * @method static object DeactivatePromoCode(\Nlocascio\Mindbody\Model\DeactivatePromoCodeRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetLiabilityWaiverResponse siteGetLiabilityWaiver();
 * @method static \Nlocascio\Mindbody\Model\GetLiabilityWaiverResponse GetLiabilityWaiver();
 ...
 * @method static \Nlocascio\Mindbody\Model\GetMobileProvidersResponse siteGetMobileProviders(bool $RequestActive = null);
 * @method static \Nlocascio\Mindbody\Model\GetMobileProvidersResponse GetMobileProviders(bool $RequestActive = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetProgramsResponse siteGetPrograms(int $RequestLimit = null, int $RequestOffset = null, bool $RequestOnlineOnly = null, int[] $RequestProgramIds = null, string $RequestScheduleType = null);
 * @method static \Nlocascio\Mindbody\Model\GetProgramsResponse GetPrograms(int $RequestLimit = null, int $RequestOffset = null, bool $RequestOnlineOnly = null, int[] $RequestProgramIds = null, string $RequestScheduleType = null);
 * @method static \Nlocascio\Mindbody\Model\GetPromoCodesResponse siteGetPromoCodes(bool $RequestActiveOnly = null, \DateTime $RequestEndDate = null, \DateTime $RequestLastModifiedDate = null, int $RequestLimit = null, int $RequestOffset = null, bool $RequestOnlineOnly = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetPromoCodesResponse GetPromoCodes(bool $RequestActiveOnly = null, \DateTime $RequestEndDate = null, \DateTime $RequestLastModifiedDate = null, int $RequestLimit = null, int $RequestOffset = null, bool $RequestOnlineOnly = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetProspectStagesResponse siteGetProspectStages(bool $RequestActive = null);
 * @method static \Nlocascio\Mindbody\Model\GetProspectStagesResponse GetProspectStages(bool $RequestActive = null);
 * @method static \Nlocascio\Mindbody\Model\GetRelationshipsResponse siteGetRelationships(bool $RequestActive = null, int $RequestLimit = null, int $RequestOffset = null);
 * @method static \Nlocascio\Mindbody\Model\GetRelationshipsResponse GetRelationships(bool $RequestActive = null, int $RequestLimit = null, int $RequestOffset = null);
 * @method static \Nlocascio\Mindbody\Model\GetResourceAvailabilitiesResponse siteGetResourceAvailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, \DateTime $RequestStartDate = null);
 * @method static \Nlocascio\Mindbody\Model\GetResourceAvailabilitiesResponse GetResourceAvailabilities(\DateTime $RequestEndDate = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null, \DateTime $RequestStartDate = null);
 * @method static object siteGetResources(bool $RequestIncludeInactive = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null);
 * @method static object GetResources(bool $RequestIncludeInactive = null, int $RequestLimit = null, int[] $RequestLocationIds = null, int $RequestOffset = null, int[] $RequestProgramIds = null, int[] $RequestResourceIds = null, string[] $RequestScheduleTypes = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetSitesResponse siteGetSites(bool $RequestIncludeLeadChannels = null, bool $RequestIncludePerStaffPricing = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSiteIds = null);
 * @method static \Nlocascio\Mindbody\Model\GetSitesResponse GetSites(bool $RequestIncludeLeadChannels = null, bool $RequestIncludePerStaffPricing = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSiteIds = null);
 * @method static \Nlocascio\Mindbody\Model\UpdateSiteClientIndexResponse siteUpdateClientIndex(\Nlocascio\Mindbody\Model\UpdateSiteClientIndexRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\UpdateSiteClientIndexResponse UpdateClientIndex(\Nlocascio\Mindbody\Model\UpdateSiteClientIndexRequest $Request);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetSalesRepsResponse staffGetSalesReps(bool $RequestActiveOnly = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSalesRepNumbers = null);
 * @method static \Nlocascio\Mindbody\Model\GetSalesRepsResponse GetSalesReps(bool $RequestActiveOnly = null, int $RequestLimit = null, int $RequestOffset = null, int[] $RequestSalesRepNumbers = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\GetStaffImageURLResponse staffGetStaffImageURL(int $RequestStaffId = null);
 * @method static \Nlocascio\Mindbody\Model\GetStaffImageURLResponse GetStaffImageURL(int $RequestStaffId = null);
 ...
 * @method static \Nlocascio\Mindbody\Model\IssueResponse userTokenIssueToken(\Nlocascio\Mindbody\Model\IssueRequest $Request);
 * @method static \Nlocascio\Mindbody\Model\IssueResponse IssueToken(\Nlocascio\Mindbody\Model\IssueRequest $Request);
 * @method static object userTokenRenewToken();
 * @method static object RenewToken();
