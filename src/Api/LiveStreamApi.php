...
class LiveStreamApi implements ApiInterface
{
    ...
    /**
     * Operation liveStreamGenerateSignedLiveStreamUrl
     *
     * Create an encrypted link to VWP live stream for third party integration customer.
     *
     * @param  \Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlRequest $Request Request (required)
     *
    ...
    /**
     * Operation liveStreamGenerateSignedLiveStreamUrlWithHttpInfo
     *
     * Create an encrypted link to VWP live stream for third party integration customer.
     *
     * @param  \Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlRequest $Request (required)
     *
     * @throws \Nlocascio\Mindbody\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlResponse',
    ...
    /**
     * Operation liveStreamGenerateSignedLiveStreamUrlAsync
     *
     * Create an encrypted link to VWP live stream for third party integration customer.
     *
     * @param  \Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlRequest $Request (required)
    ...
    /**
     * Operation liveStreamGenerateSignedLiveStreamUrlAsyncWithHttpInfo
     *
     * Create an encrypted link to VWP live stream for third party integration customer.
     *
     * @param  \Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlRequest $Request (required)
    ...
    /**
     * Create request for operation 'liveStreamGenerateSignedLiveStreamUrl'
     *
     * @param  \Nlocascio\Mindbody\Model\GenerateSignedLiveStreamUrlRequest $Request (required)
     *
     * @throws \InvalidArgumentException
    ...
    protected function liveStreamGenerateSignedLiveStreamUrlRequest($Request): \GuzzleHttp\Psr7\Request
    {
        ...
        if ($Request === null || (is_array($Request) && count($Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $Request when calling liveStreamGenerateSignedLiveStreamUrl'
            );
        }

        $resourcePath = '/public/v6/livestream/generateSignedUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
