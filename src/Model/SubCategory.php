 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property int $Id The Id of the subcategory.
 * @property string $SubCategoryName The name of the subcategory.
...
class SubCategory extends BaseModel implements ModelWithIntId
{
     ...
     * @return string
     */
    public function getSubCategoryName(): string|null
    {
     ...
     * Sets Active
     *
     * @param bool $Active When `true`, indicates that the subcategory is active.
     *
     * @return $this
     */
