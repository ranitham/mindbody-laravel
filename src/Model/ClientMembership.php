...
class ClientMembership extends BaseModel implements ModelWithIntId
{
    ...
    /**
     * Gets RestrictedLocations
     *
     * @return \Nlocascio\Mindbody\Model\Location[]
     */
    public function getRestrictedLocations(): array|null
    {
        return $this->container['RestrictedLocations'];
    }

    /**
     * Sets RestrictedLocations
     *
     * @param \Nlocascio\Mindbody\Model\Location[] $RestrictedLocations The locations that the membership is restricted to, if any.  Please note that client memberships with location restrictions can only be used to pay for scheduled services at the site to which they belong. Memberships with location restrictions can not be used to pay for scheduled services at other sites within an organization.
     *
     * @return $this
     */
     ...
     * Sets IconCode
     *
     * @param string $IconCode Text code that represents the `MembershipIcon`.
     *
     * @return $this
     */
