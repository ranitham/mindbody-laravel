...
/**
 * GetActiveSessionTimesResponse Class Doc Comment
 *
 * @category Class
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
...
class GetActiveSessionTimesResponse extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'GetActiveSessionTimesResponse';
    ...
    protected static array $setters = [
        ...
        'ActiveSessionTimes' => 'setActiveSessionTimes'
    ];
    ...
    protected static array $getters = [
        ...
        'ActiveSessionTimes' => 'getActiveSessionTimes'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['ActiveSessionTimes'] = isset($data['ActiveSessionTimes']) ? $data['ActiveSessionTimes'] : null;
    }
    ...
    /**
     * Gets ActiveSessionTimes
     *
     * @return string[]
     */
    public function getActiveSessionTimes(): array|null
    {
        return $this->container['ActiveSessionTimes'];
    }

    /**
     * Sets ActiveSessionTimes
     *
     * @param string[] $ActiveSessionTimes List of available start times for active sessions. Note the following:  * The times returned represent possibilities for scheduling a session, not necessarily currently scheduled sessions.  * The response includes either all schedule types or those filtered by supplying `ScheduleType` or `SessionTypeIds`.  * Each session has an associated schedule type, but when you supply `SessionTypeIds`, they may map to one or more of the schedule types.
     *
     * @return $this
     */


    public function setActiveSessionTimes(array $ActiveSessionTimes): static
    {
        $this->container['ActiveSessionTimes'] = $ActiveSessionTimes;
