 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property int $ProductId The unique ID associated with product.
 ...
 * @property string $ShortDescription A short text description of the product.
 * @property string $LongDescription A long, more detailed text description of the product.
 * @property int $TypeGroup The Type group of the product.
 * @property int $SupplierId The unique ID of the supplier of product.
 * @property string $SupplierName The Supplier Name of the product.
 * @property string $ImageURL The URL of the image associated with this product.
 * @property \Nlocascio\Mindbody\Model\Color $Color Contains information about color of the product.
...
class Product extends BaseModel implements ModelWithId
{
     ...
     * Sets ProductId
     *
     * @param int $ProductId The unique ID associated with product.
     *
     * @return $this
     */
     ...
     * Sets Id
     *
     * @param string $Id The barcode number of the product. This is the `PurchasedItems[].BarcodeId` returned from GET Sales.
     *
     * @return $this
     */
     ...
     * Sets CategoryId
     *
     * @param int $CategoryId The revenue category ID of the product. Use this ID when calling the GET Categories endpoint.
     *
     * @return $this
     */
     ...
     * Sets SubCategoryId
     *
     * @param int $SubCategoryId The SubCategory ID of the product. Use this ID when calling the GET Categories endpoint.
     *
     * @return $this
     */
     ...
     * Sets TaxIncluded
     *
     * @param double $TaxIncluded If tax inclusive-pricing is enabled, this field shows how much tax was added to the price. To fetch this value `LocationId` must be passed as a query parameter.
     *
     * @return $this
     */
     ...
     * Sets TaxRate
     *
     * @param double $TaxRate The tax rate that was applied to this purchase. To fetch this value `LocationId` must be passed as a query parameter.
     *
     * @return $this
     */
     ...
     *
     * @param string $ShortDescription A short text description of the product.
     *
     * @return $this
     */
     ...
     *
     * @param string $LongDescription A long, more detailed text description of the product.
     *
     * @return $this
     */
     ...
     * Sets TypeGroup
     *
     * @param int $TypeGroup The Type group of the product.
     *
     * @return $this
     */
     ...
     * Sets SupplierId
     *
     * @param int $SupplierId The unique ID of the supplier of product.
     *
     * @return $this
     */
     ...
     * Sets SupplierName
     *
     * @param string $SupplierName The Supplier Name of the product.
     *
     * @return $this
     */
     ...
     * Sets ImageURL
     *
     * @param string $ImageURL The URL of the image associated with this product.
     *
     * @return $this
     */
     ...
     * Sets Color
     *
     * @param \Nlocascio\Mindbody\Model\Color $Color Contains information about color of the product.
     *
     * @return $this
     */
     ...
     * Sets ManufacturerId
     *
     * @param string $ManufacturerId The ID number attributed to the product by the manufacturer.
     *
     * @return $this
     */
