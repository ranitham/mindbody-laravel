...
/**
 * InitiateCheckoutShoppingCartUsingAlternativePaymentsRequest Class Doc Comment
 *
 * @category Class
 * @description The API Request model for Initiate Checkout Shopping Cart API.
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 ...
 * @property string $PayerClientId The RSSID of the client paying for the purchase. This client needs to have a relationship of type \"Pays for\" with the client specified in the \"ClientId\" field.
 ...
 * @property \Nlocascio\Mindbody\Model\CheckoutAlternativePaymentInfo[] $Payments A list of payment information objects to be applied to payment against the items in the cart.
 ...
 *
 */
class InitiateCheckoutShoppingCartUsingAlternativePaymentsRequest extends BaseModel
{
    ...
    protected static $swaggerTypes = [
        ...
        'Payments' => '\Nlocascio\Mindbody\Model\CheckoutAlternativePaymentInfo[]',
        'SendEmail' => 'bool',
        'LocationId' => 'int',
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['PaymentAuthenticationCallbackUrl'] === null) {
            $invalidProperties[] = "'PaymentAuthenticationCallbackUrl' can't be null";
        }
     ...
     * Sets PayerClientId
     *
     * @param string $PayerClientId The RSSID of the client paying for the purchase. This client needs to have a relationship of type \"Pays for\" with the client specified in the \"ClientId\" field.
     *
     * @return $this
     */
     ...
     * Sets Payments
     *
     * @param \Nlocascio\Mindbody\Model\CheckoutAlternativePaymentInfo[] $Payments A list of payment information objects to be applied to payment against the items in the cart.
     *
     * @return $this
     */
