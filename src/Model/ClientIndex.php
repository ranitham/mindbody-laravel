 ...
 * @property \Nlocascio\Mindbody\Model\ClientIndexValue[] $Values Contains a list with a single object representing the index value assigned to the client index.
...
class ClientIndex extends BaseModel implements ModelWithId
{
     ...
     * Sets Values
     *
     * @param \Nlocascio\Mindbody\Model\ClientIndexValue[] $Values Contains a list with a single object representing the index value assigned to the client index.
     *
     * @return $this
     */
