...
/**
 * GetTimeCardsResponse Class Doc Comment
 *
 * @category Class
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
 ...
 * @property \Nlocascio\Mindbody\Model\TimeCardEvent[] $TimeCards Information about time card entries, ordered by staff ID.
 *
 */
class GetTimeCardsResponse extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'GetTimeCardsResponse';
    ...
    protected static array $swaggerTypes = [
        ...
        'TimeCards' => '\Nlocascio\Mindbody\Model\TimeCardEvent[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['TimeCards'] = isset($data['TimeCards']) ? $data['TimeCards'] : null;
    }
     ...
     */
    public function getTimeCards(): array|null
    {
     ...
     * Sets TimeCards
     *
     * @param \Nlocascio\Mindbody\Model\TimeCardEvent[] $TimeCards Information about time card entries, ordered by staff ID.
     *
     * @return $this
     */


    public function setTimeCards(array $TimeCards): static
    {
        $this->container['TimeCards'] = $TimeCards;
