 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property int $Id The ID of the contact log being updated.
 ...
 * @property int $AssignedToStaffId The ID of the staff member to whom the contact log is now being assigned.
 * @property string $Text The contact log’s new text.
 * @property string $ContactName The name of the new person to be contacted by the assigned staff member.
 * @property \DateTime $FollowupByDate The new date by which the assigned staff member should complete this contact log.
 * @property string $ContactMethod The new method by which the client wants to be contacted.
 ...
 * @property \Nlocascio\Mindbody\Model\UpdateContactLogComment[] $Comments Contains information about the comments being updated or added to the contact log. Comments that have an ID of `0` are added to the contact log.
