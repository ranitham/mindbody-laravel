...
class UpdateStaffRequest extends BaseModel
{
     ...
     * Sets ID
     *
     * @param int $ID The unique id of the staff
     *
     * @return $this
     */
     ...
     * Sets ProviderIDs
     *
     * @param string[] $ProviderIDs A list of providerIDs for the staff.  In the US it is one per staff and is numeric, otherwise it can be a list and is alpha-numeric  for more information see https://support.mindbodyonline.com/s/article/204075743-Provider-IDs?language=en_US
     *
     * @return $this
     */
