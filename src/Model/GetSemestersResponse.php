...
/**
 * GetSemestersResponse Class Doc Comment
 *
 * @category Class
 ...
 * @property \Nlocascio\Mindbody\Model\Semester[] $Semesters Contains the Semester objects, each of which describes the semesters for a site.
 *
 */
class GetSemestersResponse extends BaseModel
{
     ...
     * Sets Semesters
     *
     * @param \Nlocascio\Mindbody\Model\Semester[] $Semesters Contains the Semester objects, each of which describes the semesters for a site.
     *
     * @return $this
     */
