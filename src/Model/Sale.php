 ...
 *
 * @category Class
 * @description Contains the Sale details.
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
...
class Sale extends BaseModel implements ModelWithId
{
     ...
     * Sets PurchasedItems
     *
     * @param \Nlocascio\Mindbody\Model\PurchasedItem[] $PurchasedItems Contains the `PurchasedItem` objects that describe the purchased items.
     *
     * @return $this
     */
     ...
     * Sets Payments
     *
     * @param \Nlocascio\Mindbody\Model\SalePayment[] $Payments Contains the `SalePayment` objects that describe the payments that contributed to this sale.
     *
     * @return $this
     */
