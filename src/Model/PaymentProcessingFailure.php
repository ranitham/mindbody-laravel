 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property string $Type Returned only if SCA challenge is indicated.
 * @property string $Message Returned only if SCA challenge is indicated.
 * @property string $AuthenticationRedirectUrl Returned only if SCA challenge is indicated.
 *
 */
class PaymentProcessingFailure extends BaseModel
{
     ...
     * Sets Type
     *
     * @param string $Type Returned only if SCA challenge is indicated.
     *
     * @return $this
     */
     ...
     * Sets Message
     *
     * @param string $Message Returned only if SCA challenge is indicated.
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getAuthenticationRedirectUrl(): string|null
    {
     ...
     *
     * @param string $AuthenticationRedirectUrl Returned only if SCA challenge is indicated.
     *
     * @return $this
     */
