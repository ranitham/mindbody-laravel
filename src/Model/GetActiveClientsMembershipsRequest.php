 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property string[] $ClientIds The ID's of the clients whose membership was requested.
 * @property int $LocationId The ID of the location where the requested membership was created.
...
class GetActiveClientsMembershipsRequest extends BaseModel
{
     ...
     * Sets ClientIds
     *
     * @param string[] $ClientIds The ID's of the clients whose membership was requested.
     *
     * @return $this
     */
     ...
     * Sets LocationId
     *
     * @param int $LocationId The ID of the location where the requested membership was created.
     *
     * @return $this
     */
