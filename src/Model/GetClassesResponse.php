...
/**
 * GetClassesResponse Class Doc Comment
 *
 * @category Class
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
 ...
 * @property \Nlocascio\Mindbody\Model\ModelClass[] $Classes A list of the requested classes.
 *
 */
class GetClassesResponse extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetClassesResponse';
     ...
     * Sets Classes
     *
     * @param \Nlocascio\Mindbody\Model\ModelClass[] $Classes A list of the requested classes.
     *
     * @return $this
     */
