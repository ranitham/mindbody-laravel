 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property \Nlocascio\Mindbody\Model\ClientSuspensionInfo $SuspensionInfo Contains information about the client account suspension.  If **Scheduling Suspensions** setting in General Settings and Options is disabled,   this field will be null for GetClients and return validation error for UpdateClient.
...
class ClientWithSuspensionInfo extends BaseModel implements ModelWithStringId
{
     ...
     */
    public function getSuspensionInfo(): \Nlocascio\Mindbody\Model\ClientSuspensionInfo|null
    {
     ...
     * Sets SuspensionInfo
     *
     * @param \Nlocascio\Mindbody\Model\ClientSuspensionInfo $SuspensionInfo Contains information about the client account suspension.  If **Scheduling Suspensions** setting in General Settings and Options is disabled,   this field will be null for GetClients and return validation error for UpdateClient.
     *
     * @return $this
     */
