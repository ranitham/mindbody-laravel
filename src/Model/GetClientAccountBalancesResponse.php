 ...
 * @property \Nlocascio\Mindbody\Model\Client[] $Clients A list of clients.
 *
 */
class GetClientAccountBalancesResponse extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'GetClientAccountBalancesResponse';
     ...
     * Sets Clients
     *
     * @param \Nlocascio\Mindbody\Model\Client[] $Clients A list of clients.
     *
     * @return $this
     */
