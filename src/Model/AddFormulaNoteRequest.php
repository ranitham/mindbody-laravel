 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property string $ClientId The ID of the client who needs to have a formula note added.
...
class AddFormulaNoteRequest extends BaseModel
{
     ...
     * Sets ClientId
     *
     * @param string $ClientId The ID of the client who needs to have a formula note added.
     *
     * @return $this
     */
