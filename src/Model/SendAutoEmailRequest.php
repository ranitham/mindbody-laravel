 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property string $ClientId The ID of the client email will be sent to.
 * @property string $EmailType The type of the email that will be sent to a client.   Possible values are:  * BusinessWelcomeEmail  * ConsumerWelcomeEmail
 *
 */
class SendAutoEmailRequest extends BaseModel
{
     ...
     * Sets ClientId
     *
     * @param string $ClientId The ID of the client email will be sent to.
     *
     * @return $this
     */
     ...
     * Sets EmailType
     *
     * @param string $EmailType The type of the email that will be sent to a client.   Possible values are:  * BusinessWelcomeEmail  * ConsumerWelcomeEmail
     *
     * @return $this
     */
