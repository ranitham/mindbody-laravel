...
/**
 * GetAvailableDatesResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Nlocascio\Mindbody
...
class GetAvailableDatesResponse extends BaseModel
{
     ...
     * @return \DateTime[]
     */
    public function getAvailableDates(): array|null
    {
     ...
     * Sets AvailableDates
     *
     * @param \DateTime[] $AvailableDates A list of dates where scheduled appointment availability was found after applying request filters.
     *
     * @return $this
     */
