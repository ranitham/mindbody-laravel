...
/**
 * UpdateContactLogType Class Doc Comment
 *
 * @category Class
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
...
class UpdateContactLogType extends BaseModel implements ModelWithId
{
     ...
     * Sets Id
     *
     * @param int $Id The ID of the contact log type to update the subtypes of.
     *
     * @return $this
     */
     ...
     * Sets SubTypes
     *
     * @param int[] $SubTypes The subtype IDs that are to be added to the contact log.
     *
     * @return $this
     */
