 ...
 * @property int $StaffId The unique ID of the staff on appointment.
...
class AddOnSmall extends BaseModel implements ModelWithId
{
     ...
     * Sets StaffId
     *
     * @param int $StaffId The unique ID of the staff on appointment.
     *
     * @return $this
     */
     ...
     * Sets TypeId
     *
     * @param int $TypeId The ID of the session type of this appointment.
     *
     * @return $this
     */
