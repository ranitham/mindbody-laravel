 ...
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 * @property string $ClientId The ID of the client to query.
 ...
 * @property bool $CrossRegionalLookup Used to retrieve a client’s data from multiple sites within an organization.  Default: **false**
 ...
 * @property string[] $RequiredClientData Used to store the required type of data for particular client
 *
 */
