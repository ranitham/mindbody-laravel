 ...
 *
 * @category Class
 * @description Get transactions response properties
 * @package  Nlocascio\Mindbody
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
...
class GetTransactionsResponse extends BaseModel
{
     ...
     * Sets Transactions
     *
     * @param \Nlocascio\Mindbody\Model\Transaction[] $Transactions Contains the transaction objects, each of which describes the transaction details for a purchase event.
     *
     * @return $this
     */
